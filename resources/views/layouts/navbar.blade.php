    ...
    <div class="flex justify-between h-16 items-center">
        ...
        <div class="hidden xl:flex items-center justify-between gap-4	border-sky-100	">
            ...
            <form id="logout-form" method="POST" action="{{ route('logout') }}">
                @csrf
                <a href="#" id="logout-btn" class="flex items-center gap-2 p-2 rounded bg-sky-600 text-white hover:bg-sky-700">
                    Logout
                </a>
            </form>
        </div>
            ...
            <ul class="flex-1 m-4 p-2 space-y-4">
                ...
                <li>
                    <a href="/admin/products" class="flex items-center gap-2 p-2 rounded hover:bg-sky-800">
                        <img src="{{ asset('img/submenu/ic_menu_fullstock_v2_normal.svg') }}" width="30px" height="30px"
                            alt="">
                            จัดการข้อมูลสินค้า
                    </a>
                </li>
                ...
                <li>
                    <a href="/admin/users" class="flex items-center gap-2 p-2 rounded hover:bg-sky-800">
                        <img src="{{ asset('img/submenu/ic_menu_staff_v2_normal.svg') }}" width="30px" height="30px"
                            alt="">
                            จัดการพนักงาน
                    </a>
                </li>
                <div class="flex items-center justify-between border-t p-2	border-sky-100	">
                    ...
                    <form id="logout-form2" method="POST" action="{{ route('logout') }}">
                        @csrf
                        <a href="#" id="logout-btn2" class="flex items-center gap-2 p-2 rounded bg-sky-600 text-white hover:bg-sky-700">
                            Logout
                        </a>
                    </form>
                </div>
...
<div class="w-64 hidden mt-20 xl:flex fixed bg-sky-500 overflow-y-auto">
    <div class="w-64 h-screen bg-sky-900 text-white flex flex-col">
        ...
        <ul class="flex-1 m-4 p-2 space-y-4">
            <li class="">
                <a href="/admin/pos" class="flex items-center gap-2 p-2 rounded {{ $manu == 'หน้าขาย' ? ' bg-sky-600 scale-125' : '' }} hover:bg-sky-800 hover:scale-110	">
                    <img src="{{ asset('img/submenu/ic_menu_store_normal.svg') }}" width="30px" height="30px"
                        alt="">
                    หน้าขาย
                </a>
            ...
            <li class="">
                <a href="/admin/dashboard" class="flex items-center gap-2 p-2 rounded {{ $manu == 'แดชบอร์ด' ? ' bg-sky-600 scale-125' : '' }} hover:bg-sky-800 hover:scale-110	">
                    <img src="{{ asset('img/submenu/ic_dashboard_normal.svg') }}" width="30px" height="30px"
                        alt="">
                    แดชบอร์ด
                </a>
            ...
            <li>
                <a href="/admin/sales-history" class="flex items-center gap-2 p-2 rounded {{ $manu == 'ประวัติการขาย' ? ' bg-sky-600 scale-125' : '' }}  hover:bg-sky-800 hover:scale-110	">
                    <img src="{{ asset('img/submenu/ic_menu_receipt_normal.svg') }}" width="30px"
                        height="30px" alt="">
                    ประวัติการขาย
                </a>
            ...
            <li>
                <a href="/admin/products" class="flex items-center gap-2 p-2 rounded {{ $manu == 'จัดการข้อมูลสินค้า' ? ' bg-sky-600 scale-125' : '' }} hover:bg-sky-800 hover:scale-110	">
                    <img src="{{ asset('img/submenu/ic_menu_fullstock_v2_normal.svg') }}" width="30px" height="30px"
                        alt="">
                        จัดการข้อมูลสินค้า
                </a>
            ...
            <li>
                <a href="/admin/categories" class="flex items-center gap-2 p-2 rounded {{ $manu == 'จัดการประเภทสินค้า' ? ' bg-sky-600 scale-125' : '' }} hover:bg-sky-800 hover:scale-110	">
                    <img src="{{ asset('img/submenu/ic_wholesale.svg') }}" width="30px" height="30px"
                        alt="">
                        จัดการประเภทสินค้า
                </a>
            ...
            <li>
                <a href="/admin/users" class="flex items-center gap-2 p-2 rounded {{ $manu == 'พนักงาน' ? ' bg-sky-600 scale-125' : '' }} hover:bg-sky-800 hover:scale-110	">
                    <img src="{{ asset('img/submenu/ic_menu_staff_v2_normal.svg') }}" width="30px" height="30px"
                        alt="">
                        จัดการพนักงาน
                </a>
